...
!!        when the exchange is in the y direction relative to the cubed-sphere
!!        panel's orientation.

module ffsl_halo_correct_y_kernel_mod
  ...
  !> Psy layer.
  !>
  type, public, extends(kernel_type) :: ffsl_halo_correct_y_kernel_type
    private
  ...
  contains
    procedure, nopass :: ffsl_halo_correct_y_code
  end type

  !---------------------------------------------------------------------------
  ! Contained functions/subroutines
  !---------------------------------------------------------------------------
  public :: ffsl_halo_correct_y_code

contains

!> @brief Kernel which performs halo exchange in the y direction.
...
subroutine ffsl_halo_correct_y_code( nlayers,              &
                                     rho_out,              &
                                     rho_x_in,             &
                                     rho_y_in,             &
                                     cell_orientation,     &
...
end subroutine ffsl_halo_correct_y_code

end module ffsl_halo_correct_y_kernel_mod
